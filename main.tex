...
\fancyfoot[R]{\scriptsize \ttfamily Trang {\thepage}/41}
...
\begin{document}
    ...
    \begin{thebibliography}{9}
        ...
        % \bibitem{key4}
        % Hồ Lê Viên, Các máy gia công vật liệu rắn và dẻo tập 2, Nhà xuất bản khoa học và kỹ thuật
        \end{thebibliography}
\end{document}